<?
class Trainers extends CActiveRecord
{
	...
	{
		return array(
			array('created_at, top_int', 'numerical', 'integerOnly'=>true),
			array('name_text, url_text, weight_text, position_text, kazposition_text, engposition_text, dr_int, gr_text', 'length', 'max'=>255),
            ...
            array('bio_bigtexteditor, kazbio_bigtexteditor, engbio_bigtexteditor, kar_bigtexteditor, kazkar_bigtexteditor, engkar_bigtexteditor', 'length', 'max'=>1000),
	...
	public function attributeLabels()
	{
		return array(
			...
			'position_text' => 'Звание',
            'kazposition_text' => 'Звание (ҚАЗ)',
            'engposition_text' => 'Звание (ENG)',
            ...
            'dr_int' => 'Дата рождения',
            'gr_text' => 'Гражданство',
            'kazgr_text' => 'Гражданство (ҚАЗ)',
            'enggr_text' => 'Гражданство (ENG)',
            'bio_bigtexteditor' => 'Биография',
            'kazbio_bigtexteditor' => 'Биография (ҚАЗ)',
            'engbio_bigtexteditor' => 'Биография (ENG)',
            'kar_bigtexteditor' => 'Карьера',
            'kazkar_bigtexteditor' => 'Карьера (ҚАЗ)',
            'engkar_bigtexteditor' => 'Карьера (ENG)',
		);
	}
    ...
    {
        return array(
            //'parentCategory'=>array( self::BELONGS_TO, 'Trainerscategory', 'category_int' )
        );
    }
    ...
    public function defaultScope() {
        return array(
            'order' => 'weight_text + 0 ASC, created_at DESC, id + 0 DESC',
        );
    }
