<?
class Portfolioimages extends CActiveRecord
{
    ...
    {
        return array(
            'parentcategory'=>array( self::BELONGS_TO, 'Portfolio', 'parent_id' ),
        );
    }
	...
	{
		return array(
			array('created_at,parent_id', 'numerical', 'integerOnly'=>true),
			array('name_text, url_text, serial_number, serial_landingnumber', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
            ...
            'serial_landingnumber' => 'Порядковый номер в лэндингах*',
            'parent_id' => 'Относится к группе',
		);
	}
