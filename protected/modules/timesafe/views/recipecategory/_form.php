...
echo CHtml::hiddenField('Recipecategory_page',$_GET['Recipecategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Recipecategory_page'=>$_GET['Recipecategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Recipecategory_page'=>$_GET['Recipecategory_page'])); ?>
	</div>
<script>
    $('#Recipecategory_name_text').change(function() {
        $('#Recipecategory_url_text').val(cyr2lat($('#Recipecategory_name_text').val()));
    });
