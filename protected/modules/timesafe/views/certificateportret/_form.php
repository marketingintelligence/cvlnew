<?php
    ...
    echo CHtml::hiddenField('Certificateportret_page',$_GET['Certificateportret_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Certificateportret_page'=>$_GET['Certificateportret_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Certificateportret_page'=>$_GET['Certificateportret_page'])); ?>
	</div>

<script>
    $('#Certificateportret_name_text').change(function() {
        $('#Certificateportret_url_text').val(cyr2lat($('#Certificateportret_name_text').val()));
    });
