...
echo CHtml::hiddenField('Meatsubcategory_page',$_GET['Meatsubcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Meatsubcategory_page'=>$_GET['Meatsubcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Meatsubcategory_page'=>$_GET['Meatsubcategory_page'])); ?>
	</div>
<script>
    $('#Meatsubcategory_name_text').change(function() {
        $('#Meatsubcategory_url_text').val(cyr2lat($('#Meatsubcategory_name_text').val()));
    });
