...
echo CHtml::hiddenField('Fishcategory_page',$_GET['Fishcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Fishcategory_page'=>$_GET['Fishcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Fishcategory_page'=>$_GET['Fishcategory_page'])); ?>
	</div>
<script>
    $('#Fishcategory_name_text').change(function() {
        $('#Fishcategory_url_text').val(cyr2lat($('#Fishcategory_name_text').val()));
    });
