...
echo CHtml::hiddenField('Followerscategory_page',$_GET['Followerscategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Followerscategory_page'=>$_GET['Followerscategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Followerscategory_page'=>$_GET['Followerscategory_page'])); ?>
	</div>
<script>
    $('#Followerscategory_name_text').change(function() {
        $('#Followerscategory_url_text').val(cyr2lat($('#Followerscategory_name_text').val()));
    });
