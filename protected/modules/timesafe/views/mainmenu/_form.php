...
echo CHtml::hiddenField('Mainmenu_page',$_GET['Mainmenu_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Mainmenu_page'=>$_GET['Mainmenu_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Mainmenu_page'=>$_GET['Mainmenu_page'])); ?>
	</div>
<? $this->endWidget(); ?>
