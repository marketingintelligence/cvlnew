<?php
    ...
    echo CHtml::hiddenField('Cvlnews_page',$_GET['Cvlnews_page']);
?>
<style>
    .span {
        width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Cvlnews_page'=>$_GET['Cvlnews_page'])); ?>    </div>
	    ...
	    <?php echo $form->textFieldRow($model, 'short_texteditor', array('size' => 60, 'maxlength' => 255, 'class'=>'span12')); ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Cvlnews_page'=>$_GET['Cvlnews_page'])); ?>
	</div>

<script>
    $('#Cvlnews_name_text').change(function() {
        $('#Cvlnews_url_text').val(cyr2lat($('#Cvlnews_name_text').val()));
    });
