<?php
    ...
    echo CHtml::hiddenField('Academypages_page',$_GET['Academypages_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Academypages_page'=>$_GET['Academypages_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Academypages_page'=>$_GET['Academypages_page'])); ?>
	</div>

<script>
    $('#Academypages_name_text').change(function() {
        $('#Academypages_url_text').val(cyr2lat($('#Academypages_name_text').val()));
    });
