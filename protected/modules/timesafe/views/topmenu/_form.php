...
echo CHtml::hiddenField('Topmenu_page',$_GET['Topmenu_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Topmenu_page'=>$_GET['Topmenu_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Topmenu_page'=>$_GET['Topmenu_page'])); ?>
	</div>
<? $this->endWidget(); ?>
