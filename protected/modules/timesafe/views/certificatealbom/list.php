<div class="module-title">
    <?=Certificatealbom::modelTitle()?>&nbsp;<a href="<?=$this->createUrl('create')?>" class="btn btn-success"><i class="icon-plus"></i> Добавить</a>
</div>

<div id="search-Certificatealbom-form">
    ...
    $(function () {
        $('.modal-delete').click(function(e){
          ...
          $.get('<?=$this->createUrl('remove')?>',{id:id},function(){
            $.fn.yiiListView.update($('#search-Certificatealbom-form .list-view').attr('id'));
            _refreshTrash();
          });
        });
