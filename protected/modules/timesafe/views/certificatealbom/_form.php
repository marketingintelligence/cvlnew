<?php
    ...
    echo CHtml::hiddenField('Certificatealbom_page',$_GET['Certificatealbom_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Certificatealbom_page'=>$_GET['Certificatealbom_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Certificatealbom_page'=>$_GET['Certificatealbom_page'])); ?>
	</div>

<script>
    $('#Certificatealbom_name_text').change(function() {
        $('#Certificatealbom_url_text').val(cyr2lat($('#Certificatealbom_name_text').val()));
    });
