<?php
    ...
    echo CHtml::hiddenField('Advice_page',$_GET['Advice_page']);
?>
<style>
    .span {
        width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Advice_page'=>$_GET['Advice_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Advice_page'=>$_GET['Advice_page'])); ?>
	</div>

<script>
    $('#Advice_name_text').change(function() {
        $('#Advice_url_text').val(cyr2lat($('#Advice_name_text').val()));
    });
