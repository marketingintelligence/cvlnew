<div class="module-title">
    <?=Advice::modelTitle()?>&nbsp;<a href="<?=$this->createUrl('create')?>" class="btn btn-success"><i class="icon-plus"></i> Добавить</a>
</div>

<div id="search-Advice-form">
    ...
    $(function () {
        $('.modal-delete').click(function(e){
          ...
          $.get('<?=$this->createUrl('remove')?>',{id:id},function(){
            $.fn.yiiListView.update($('#search-Advice-form .list-view').attr('id'));
            _refreshTrash();
          });
        });
