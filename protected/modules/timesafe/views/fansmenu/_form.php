...
echo CHtml::hiddenField('Fansmenu_page',$_GET['Fansmenu_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Fansmenu_page'=>$_GET['Fansmenu_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Fansmenu_page'=>$_GET['Fansmenu_page'])); ?>
	</div>
<? $this->endWidget(); ?>
