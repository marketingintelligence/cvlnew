<?php
    ...
    echo CHtml::hiddenField('Fanspages_page',$_GET['Fanspages_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Fanspages_page'=>$_GET['Fanspages_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Fanspages_page'=>$_GET['Fanspages_page'])); ?>
	</div>

<script>
    $('#Fanspages_name_text').change(function() {
        $('#Fanspages_url_text').val(cyr2lat($('#Fanspages_name_text').val()));
    });
