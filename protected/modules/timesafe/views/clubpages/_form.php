<?php
    ...
    echo CHtml::hiddenField('Clubpages_page',$_GET['Clubpages_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Clubpages_page'=>$_GET['Clubpages_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Clubpages_page'=>$_GET['Clubpages_page'])); ?>
	</div>

<script>
    $('#Clubpages_name_text').change(function() {
        $('#Clubpages_url_text').val(cyr2lat($('#Clubpages_name_text').val()));
    });
