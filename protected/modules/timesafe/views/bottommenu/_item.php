<div class="row">
    <div class="offset">
        ...
        <p class="pull-right">
            <?=CHtml::checkbox('BottommenuCheck[status_int][' . $data->id . ']', $data->status_int, array('class' => 'toggle-on-check'))?>
        ...
        <h3 style = "margin-top:5px;">
            <a target = "_blank" href = "/<?=$data->url_text?>"><?=$data->name_text?></a>
        </h3>
        <p style = "margin-left:0;">Ссылка: <a target = "_blank" href = "/<?=$data->url_text?>"><?=$data->url_text?></a></p>
