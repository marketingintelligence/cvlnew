...
echo CHtml::hiddenField('Topsoc_page',$_GET['Topsoc_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Topsoc_page'=>$_GET['Topsoc_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Topsoc_page'=>$_GET['Topsoc_page'])); ?>
	</div>
<? $this->endWidget(); ?>
