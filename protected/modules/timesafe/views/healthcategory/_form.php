...
echo CHtml::hiddenField('Healthcategory_page',$_GET['Healthcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Healthcategory_page'=>$_GET['Healthcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Healthcategory_page'=>$_GET['Healthcategory_page'])); ?>
	</div>
<script>
    $('#Healthcategory_name_text').change(function() {
        $('#Healthcategory_url_text').val(cyr2lat($('#Healthcategory_name_text').val()));
    });
