...
echo CHtml::hiddenField('Dietcategory_page',$_GET['Dietcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Dietcategory_page'=>$_GET['Dietcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Dietcategory_page'=>$_GET['Dietcategory_page'])); ?>
	</div>
<script>
    $('#Dietcategory_name_text').change(function() {
        $('#Dietcategory_url_text').val(cyr2lat($('#Dietcategory_name_text').val()));
    });
