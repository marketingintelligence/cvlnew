<?php
    ...
    echo CHtml::hiddenField('Employee_page',$_GET['Employee_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Employee_page'=>$_GET['Employee_page'])); ?>    </div>
        ...
        <?php echo $form->textFieldRow($model, 'position', array('size' => 60, 'maxlength' => 255, 'class'=>'span12')); ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Employee_page'=>$_GET['Employee_page'])); ?>
	</div>

<script>
    $('#Employee_name_text').change(function() {
        $('#Employee_url_text').val(cyr2lat($('#Employee_name_text').val()));
    });
