...
echo CHtml::hiddenField('Fishsubcategory_page',$_GET['Fishsubcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Fishsubcategory_page'=>$_GET['Fishsubcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Fishsubcategory_page'=>$_GET['Fishsubcategory_page'])); ?>
	</div>
<script>
    $('#Fishsubcategory_name_text').change(function() {
        $('#Fishsubcategory_url_text').val(cyr2lat($('#Fishsubcategory_name_text').val()));
    });
