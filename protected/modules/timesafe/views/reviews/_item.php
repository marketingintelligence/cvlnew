<div class="row">
    <div class="offset">
        ...
        <p class="pull-right">
            <?=CHtml::checkbox('ReviewsCheck[status_int][' . $data->id . ']', $data->status_int, array('class' => 'toggle-on-check'))?>
        ...
        <h4 style = "margin-top:5px;">
            Порядковый номер : <?=$data->serial_number?>
        </h4>
        <img src="/upload/Reviews/sm/<?=$img[0];?>">
    </div>
</div>