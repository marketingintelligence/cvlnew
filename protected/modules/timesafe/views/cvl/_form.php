<?php
    ...
    echo CHtml::hiddenField('Cvl_page',$_GET['Cvl_page']);
?>
    <div class="form-actions">
        ...
        <?=CHtml::link('назад', array('list','Cvl_page'=>$_GET['Cvl_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Cvl_page'=>$_GET['Cvl_page'])); ?>
    </div>

<script>
    $('#Cvl_name_text').change(function() {
        $('#Cvl_url_text').val(cyr2lat($('#Cvl_name_text').val()));
    });
