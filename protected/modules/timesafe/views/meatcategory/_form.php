...
echo CHtml::hiddenField('Meatcategory_page',$_GET['Meatcategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Meatcategory_page'=>$_GET['Meatcategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Meatcategory_page'=>$_GET['Meatcategory_page'])); ?>
	</div>
<script>
    $('#Meatcategory_name_text').change(function() {
        $('#Meatcategory_url_text').val(cyr2lat($('#Meatcategory_name_text').val()));
    });
