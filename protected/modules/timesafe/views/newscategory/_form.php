...
echo CHtml::hiddenField('Newscategory_page',$_GET['Newscategory_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Newscategory_page'=>$_GET['Newscategory_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Newscategory_page'=>$_GET['Newscategory_page'])); ?>
	</div>
<script>
    $('#Newscategory_name_text').change(function() {
        $('#Newscategory_url_text').val(cyr2lat($('#Newscategory_name_text').val()));
    });
