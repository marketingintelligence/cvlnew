<?php
    ...
    echo CHtml::hiddenField('Diet_page',$_GET['Diet_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Diet_page'=>$_GET['Diet_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Diet_page'=>$_GET['Diet_page'])); ?>
	</div>

<script>
    $('#Diet_name_text').change(function() {
        $('#Diet_url_text').val(cyr2lat($('#Diet_name_text').val()));
    });
