...
echo CHtml::hiddenField('Clubmenu_page',$_GET['Clubmenu_page']);
?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Clubmenu_page'=>$_GET['Clubmenu_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Clubmenu_page'=>$_GET['Clubmenu_page'])); ?>
	</div>
<? $this->endWidget(); ?>
